...
class TrivialTaskTest {
    ...
    @Test
    void testToString() {
        String validation = "Task.TrivialTask;Date;"+LocalDate.now().toString()+";ZadanieTestowe;Szczegóły niniejszego zadania są zawarte wyłącznie w celach testowych;false;";
