...
class WorkTaskTest {
    ...
    void getDeadlineChangeCounter() {
        ...
        testTask.editTaskDeadlineInApplicationAndDB(changeDeadline);
    ...
    void editTaskDeadline_correct() {
        ...
        testTask.editTaskDeadlineInApplicationAndDB(newDeadline);
    ...
    void editTaskDeadline_exceeded() {
        ...
        testTask.editTaskDeadlineInApplicationAndDB(newDeadline1);
        testTask.editTaskDeadlineInApplicationAndDB(newDeadline2);
        testTask.editTaskDeadlineInApplicationAndDB(newDeadline3);
        testTask.editTaskDeadlineInApplicationAndDB(newDeadline4);
