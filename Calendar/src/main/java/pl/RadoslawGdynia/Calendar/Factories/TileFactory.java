...
import pl.RadoslawGdynia.Calendar.Controllers.GetBetterCalendarController;
import pl.RadoslawGdynia.Calendar.Tiles.CalendarTile;
import pl.RadoslawGdynia.Calendar.Tiles.PlanTile;
import pl.RadoslawGdynia.Calendar.Tiles.Tile;
import pl.RadoslawGdynia.Calendar.Tiles.TimeTile;
...
public class TileFactory {
    ...
    public static void createSetOfTiles(String typeOfTile, Pane rootPane, int numberOfTiles) throws IllegalArgumentException {
        ...
        if (typeOfTile.equals(CalendarTile.class.getSimpleName())) {
            final int currentYearNum = GetBetterCalendarController.getInstance().getCurrentYearNum();
            final int currentMonthNum = GetBetterCalendarController.getInstance().getCurrentMonthNum();
