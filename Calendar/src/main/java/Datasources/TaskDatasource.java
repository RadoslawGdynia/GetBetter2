...
public class TaskDatasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:P:\\GitHub repozytoria\\Repozytoria Online\\com.RadoslawGdynia.GetBetter\\Calendar\\src\\main\\resources\\" + DB_NAME;
    ...
    public void querySubtasks(Task task){
        ...
        try(Statement statement = conn.createStatement()){
            ...
            log.error("Error took place while querying subtasks for task: " + task.getTaskName()+ ". Message: " + e.getMessage());
        }
